...
public class EditBookPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        textContent.setText(book.getContent());
        ...
        textBrief.setText(book.getBrief());
    ...
    private void btnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseClicked
        if (!textTitle.getText().equals("")) {
            ...
            if (bookService.updateBook(book)) {
                Window.getInstance().getBookBuffer().updateBook(book);
                JOptionPane.showMessageDialog(Window.getInstance(), "Updated.");
            } else {
                JOptionPane.showMessageDialog(Window.getInstance(), "An error occur.");
            }
        } else {
            JOptionPane.showMessageDialog(Window.getInstance(), "Nothing changed.");
        }
